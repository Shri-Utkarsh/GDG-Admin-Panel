  ...
  return (
    <div className="mx-5">
      ...
      <div className="flex items-center justify-center my-10 gap-5">
        <img src="/google-developers.svg" alt="" className="w-10" />
        <h1 className=" text-xl 570px:text-3xl font-bold ">Google Developer Admin Panel</h1>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-wrap sm:flex-nowrap gap-2">
          <button className="text-white bg-purple-600 px-4 py-2 rounded-lg ">User Portal</button>
          <button onClick={saveScores} className="text-white bg-purple-600 px-4 py-2 rounded-lg">Save</button>
        </div>
      </div>
